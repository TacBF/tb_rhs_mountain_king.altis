  ...
  class mission
  {
    ...
    class scoring
    {
      class tickets
      {
        ...
        bluFor = 12; // "_rate" is dependent on the "missionScale".
        opFor = 60;
      };
    };
  };
    ...
    class roles
    {
      ...
      kits[] =
      {
        ...
        // OPFOR (delete OPFOR array or leave OPFOR array empty, to re-use (copy) BLUFOR array for both sides)
        {
          ...
          {__ICE_gear_AA, "Anti-Air", 22, 3, 0, 0, 0},
          {__ICE_gear_Marksman, "Marksman", 10, 0, 0, 2, 3},
